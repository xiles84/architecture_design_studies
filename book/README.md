...
from `book/evidence/v2/claims.json`.
...
book/
  ...
  lib/evidence.typ         loads book/evidence/v2/claims.json and renders the confidence cards
  ...
  evidence/                the v1 registry (frozen) and the active v2 correction package
...
- One evidence source: `lib/evidence.typ` reads only `evidence/v2/claims.json`; v1 is historical.
