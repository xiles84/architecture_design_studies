# Study 05 — external cache throughput and consistency — run `20260923T0240Z-openloop`

Generated 2026-09-24T02:04:40Z from 1 result file(s). This report contains measurements only; conclusions live in
signed analyses under `reports/analyses/`.

| Field | Value |
|---|---|
| Study | 05-cache-consistency |
| Run id | `20260923T0240Z-openloop` |
| Environment | `host-zenbook-ux5406sa` |
| Repository commit | `ee92bc154aeccb54f5c351aeb78da32f8702a251` |
| `git describe` | `run/05-cache-consistency/20260923T0220Z-openloop-1-gee92bc1` |
| Working tree dirty at start | false |
| Run tag | `run/05-cache-consistency/20260923T0240Z-openloop` |
| Benchmark image | `localhost/cachebench:1` (`e12abcd4a7f0ffa38d4`) |
| Resource framing | `db-only` |
| **Inputs digest** | `34f3c1679c46e52b` |
| Cells | 1 |
...
- Highest and lowest measured throughput across all cells: 20k (`pg-single/o:opt:red:asd:rel/warm_read_only`) and 20k (`pg-single/o:opt:red:asd:rel/warm_read_only`).

This list ranks by number only. Which scenario is *better* is not a measurement and is not stated here.

## Analyses of this data

No signed analysis exists yet for inputs digest `34f3c1679c46e52b`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | warm_read_only | cacheable | 20k | 0.16 | 0.85 | 138 | 41127 | 0 | 0.0 | 0 | 0.00% |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | openloop_6000_ops_s | 6000 | 6000 | 60001 | 60001 | 60001 | 0 | 0 | 0 | YES — scheduling lag exceeded one arrival slot at p99 | 0.15 | 0.60 | 202 | 1.13 | 0 | 0.00% |
| pg-single | `o:opt:red:asd:rel` | openloop_12000_ops_s | 12000 | 11774 | 120001 | 119978 | 119978 | 0 | 0 | 23 | YES — arrivals dropped: the buffer filled before a worker could take them | 0.13 | 0.65 | 227 | 1.15 | 0 | 0.00% |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | cold_fill | 400 | 400 | 0 | 0.00% | 151 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
| pg-single | `o:opt:red:asd:rel` | warm_read_only | 50293 | 50293 | 0 | 0.00% | 49499 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
| pg-single | `o:opt:red:asd:rel` | openloop_6000_ops_s | 60001 | 60001 | 0 | 0.00% | 59995 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
| pg-single | `o:opt:red:asd:rel` | openloop_12000_ops_s | 119978 | 119978 | 0 | 0.00% | 119978 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
...
|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | 0-75s | 229472 | 9839 | 4.3% | 0 to 0.25 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | 10491 | 178 | 158 | 220 | 178 | 0 | 0 | 100ms | 4 x measured p99 fill latency, raised to the 100 ms floor (p99 fill = 649µs) |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | 7.4.11 | 33554432 | allkeys-lru | — | 3420600 | 3433600 | 249812 | 4110 | 0 | 0 | 287218 | 13230015 | 498135717 | 3.241206 | 1.655049 |
...
|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | 239 | 23 | 4557 | db-only | 8 |
