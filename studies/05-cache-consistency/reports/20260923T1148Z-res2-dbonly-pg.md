# Study 05 — external cache throughput and consistency — run `20260923T1148Z-res2-dbonly-pg`

Generated 2026-09-23T11:38:23Z from 1 result file(s). This report contains measurements only; conclusions live in
signed analyses under `reports/analyses/`.

| Field | Value |
|---|---|
| Study | 05-cache-consistency |
| Run id | `20260923T1148Z-res2-dbonly-pg` |
| Environment | `host-zenbook-ux5406sa` |
| Repository commit | `e2d3eb42203bc12dc88d51004235282e329ab271` |
| `git describe` | `run/05-cache-consistency/20260923T1145Z-res-yb3-1-ge2d3eb4` |
| Working tree dirty at start | false |
| Run tag | `run/05-cache-consistency/20260923T1148Z-res2-dbonly-pg` |
| Benchmark image | `localhost/cachebench:1` (`86aaa3803d9358d2aba`) |
| Resource framing | `db-only` |
| **Inputs digest** | `b28d8dd331c4c968` |
| Cells | 1 |
...
- Highest and lowest measured throughput across all cells: 8.1k (`pg-single/o:opt:red:wth:str/cacheable_99_reads`) and 7.7k (`pg-single/o:opt:red:wth:str/cacheable_90_reads`).

This list ranks by number only. Which scenario is *better* is not a measurement and is not stated here.

## Analyses of this data

No signed analysis exists yet for inputs digest `b28d8dd331c4c968`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:wth:str` | warm_read_only | cacheable | 8.0k | 0.49 | 8.59 | 667 | 50633 | 0 | 16.4 | 0 | 0.00% |
| pg-single | `o:opt:red:wth:str` | cacheable_99_reads | cacheable | 8.1k | 0.53 | 7.85 | 653 | 48558 | 0 | 28.6 | 0 | 0.00% |
| pg-single | `o:opt:red:wth:str` | cacheable_90_reads | cacheable | 7.7k | 0.53 | 7.62 | 603 | 47513 | 0 | 7.9 | 0 | 0.00% |
| pg-single | `o:opt:red:wth:str` | app_99_reads | total app | 7.9k | 0.15 | 2.57 | 684 | 62539 | 0 | 19.3 | 0 | 0.00% |
| pg-single | `o:opt:red:wth:str` | app_90_reads | total app | 3.2k | 0.17 | 6.28 | 688 | 24778 | 0 | 17.6 | 0 | 0.00% |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:wth:str` | cold_fill | 400 | 400 | 0 | 0.00% | 149 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
| pg-single | `o:opt:red:wth:str` | warm_read_only | 55612 | 55612 | 0 | 0.00% | 54817 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
| pg-single | `o:opt:red:wth:str` | app_99_reads | 56125 | 55881 | 0 | 0.00% | 55811 | 0.00% | 0 | 0 | — | — | 0 | 1580 | 324 | 0 | — |
| pg-single | `o:opt:red:wth:str` | cacheable_99_reads | 109034 | 108790 | 0 | 0.00% | 108720 | 0.00% | 0 | 0 | — | — | 0 | 2234 | 324 | 0 | — |
| pg-single | `o:opt:red:wth:str` | app_90_reads | 128866 | 128162 | 0 | 0.00% | 127899 | 0.00% | 0 | 0 | — | — | 0 | 4174 | 980 | 0 | — |
| pg-single | `o:opt:red:wth:str` | cacheable_90_reads | 180218 | 179514 | 0 | 0.00% | 179251 | 0.00% | 0 | 0 | — | — | 0 | 5587 | 980 | 0 | — |
...
|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:wth:str` | 0-75s | 234068 | 3676 | 1.6% | 0 to 0.25 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:wth:str` | 5469 | 172 | 159 | 682 | 172 | 13 | 0 | 500ms | not yet calibrated |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:wth:str` | redis | 256.0 KiB | — | 0 | 0 | 5247 | 4967 | 280 | 0 | 0 | 6996 | 0 | 0 | 0 | 0 | 0 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:wth:str` | 7.4.11 | 33554432 | allkeys-lru | — | 3486480 | 3561688 | 259467 | 9932 | 0 | 0 | 317185 | 25108578 | 508427082 | 6.714383 | 3.135879 |
...
|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:wth:str` | 404 | 187 | 19775 | db-only | 8 |
