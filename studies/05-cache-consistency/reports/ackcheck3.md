# Study 05 — external cache throughput and consistency — run `ackcheck3`

Generated 2026-09-21T16:37:10Z from 3 result file(s). This report contains measurements only; conclusions live in
...
| **Inputs digest** | `6d753bf34f783b79` |
| Cells | 3 |
...
- Cells reported: 3; cells that failed: 0.
...
No signed analysis exists yet for inputs digest `6d753bf34f783b79`.
...
|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `l:na:mem:asd:str` | 20 | 0 | 0 | — | 0 | 0 | 0 | 100ms | 4 x measured p99 fill latency, raised to the 100 ms floor (p99 fill = 642µs) |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `l:na:mem:asd:str` | memory | 256.0 KiB | 10.3 KiB | 5 | 0 | 20 | 20 | 0 | 0 | 0 | 650 | 0 | 0 | 0 | 0 | 0 |
...
|---|---|---|---|---|---|---|
| pg-single | `l:na:mem:asd:str` | 5 | 0 | 0 | db-only | 8 |
| pg-single | `o:opt:db` | 6 | 0 | 0 | db-only | 8 |
| pg-single | `ref-norm` | 4 | 0 | 0 | db-only | 8 |
