# Study 05 — external cache throughput and consistency — run `20260923T0255Z-openloop`

Generated 2026-09-24T02:13:38Z from 1 result file(s). This report contains measurements only; conclusions live in
signed analyses under `reports/analyses/`.

| Field | Value |
|---|---|
| Study | 05-cache-consistency |
| Run id | `20260923T0255Z-openloop` |
| Environment | `host-zenbook-ux5406sa` |
| Repository commit | `ee92bc154aeccb54f5c351aeb78da32f8702a251` |
| `git describe` | `run/05-cache-consistency/20260923T0240Z-openloop` |
| Working tree dirty at start | false |
| Run tag | `run/05-cache-consistency/20260923T0255Z-openloop` |
| Benchmark image | `localhost/cachebench:1` (`e12abcd4a7f0ffa38d4`) |
| Resource framing | `db-only` |
| **Inputs digest** | `50d5a426c89e96cf` |
| Cells | 1 |
...
- Highest and lowest measured throughput across all cells: 21k (`pg-single/o:opt:red:asd:rel/warm_read_only`) and 21k (`pg-single/o:opt:red:asd:rel/warm_read_only`).
...
|---|---|---|---|
| `20260923T0255Z-openloop--deepseek-flash--2026-09-23` | deepseek-flash | `50d5a426c89e96cf` | current |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | warm_read_only | cacheable | 21k | 0.16 | 0.76 | 161 | 42376 | 0 | 0.0 | 0 | 0.00% |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | openloop_5000_ops_s | 5000 | 4969 | 50000 | 50000 | 50000 | 0 | 0 | 0 | YES — scheduling lag exceeded one arrival slot at p99 | 0.14 | 0.58 | 221 | 1.12 | 0 | 0.00% |
| pg-single | `o:opt:red:asd:rel` | openloop_30000_ops_s | 30000 | 15599 | 300004 | 158294 | 158294 | 0 | 0 | 141710 | YES — arrivals dropped: the buffer filled before a worker could take them | 0.14 | 0.74 | 224 | 49 | 0 | 0.00% |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | cold_fill | 400 | 400 | 0 | 0.00% | 155 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
| pg-single | `o:opt:red:asd:rel` | warm_read_only | 51985 | 51985 | 0 | 0.00% | 51193 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
| pg-single | `o:opt:red:asd:rel` | openloop_5000_ops_s | 50000 | 50000 | 0 | 0.00% | 49992 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
| pg-single | `o:opt:red:asd:rel` | openloop_30000_ops_s | 158294 | 158294 | 0 | 0.00% | 158294 | 0.00% | 0 | 0 | — | — | 0 | — | 0 | 0 | — |
...
|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | 0-75s | 259479 | 10940 | 4.2% | 0 to 0.25 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | 11554 | 216 | 196 | 214 | 216 | 0 | 0 | 100ms | 4 x measured p99 fill latency, raised to the 100 ms floor (p99 fill = 539µs) |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | 7.4.11 | 33554432 | allkeys-lru | — | 3420696 | 3431560 | 281983 | 4110 | 0 | 0 | 322616 | 14587381 | 562854071 | 3.543405 | 1.685260 |
...
|---|---|---|---|---|---|---|
| pg-single | `o:opt:red:asd:rel` | 238 | 124 | 21569 | db-only | 8 |
