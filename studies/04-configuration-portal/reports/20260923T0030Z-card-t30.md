# Study 04 — configuration portal — run `20260923T0030Z-card-t30`

Generated 2026-09-23T00:42:58Z from 4 result file(s). This report contains measurements only.

| Field | Value |
|---|---|
| Study | 04-configuration-portal |
| Run id | `20260923T0030Z-card-t30` |
| Environment | `host-zenbook-ux5406sa` |
| Repository commit | `5f2f36fe24fcf898d27e8285451a7d872186a11b` |
| `git describe` | `run/04-configuration-portal/20260923T0030Z-card-t10` |
| Working tree dirty at start | false |
| Run tag | `run/04-configuration-portal/20260923T0030Z-card-t30` |
| **Inputs digest** | `7e4698f4b24b6b41` |
| Cells | 4 |
...
- Highest and lowest valid read result, across all cells and reads: 42208.0 ops/s (`pg-single/n1/r03_revision_check`) and 1854.0 ops/s (`pg-single/n1/r04_list_installations`).

This list ranks by number only. Which design is *better* is not a measurement and is not stated here.

## Analyses of this data

No signed analysis exists yet for inputs digest `7e4698f4b24b6b41`.

## Cells

| Topology | Design | Family | Kind | Gate | Load s | Entries | Serialized B |
|---|---|---|---|---|---|---|---|
| pg-single | `n0_rows_unindexed` | normalized | rows | pass | 0.01 | 1800 | 199.2 KiB |
| pg-single | `n1_rows_indexed` | normalized | rows | pass | 0.01 | 1800 | 199.2 KiB |
| pg-single | `n3_rollup_trigger` | rollup | rows | pass | 0.02 | 1800 | 199.2 KiB |
| pg-single | `n4_rollup_app` | rollup | rows | pass | 0.01 | 1800 | 199.2 KiB |
...
| Entries per installed product (tier) | 30 |
| Cardinality mode | exact |
| Value regime | small |
| Key bytes | 16 |
| Value bytes | 96 |
| Total entries | 1800 |
| Total serialized bytes | 199.2 KiB |
| Mean serialized bytes per installation | 3400 |
...
|---|---|---|---|---|---|---|---|---|---|
| pg-single | `n0` | r01_effective_config | 18k | 0.17 | 0.49 | 50 | 269424 | 0 | 1.4 |
| pg-single | `n0` | r02_read_key | 24k | 0.15 | 0.44 | 39 | 357040 | 0 | 7.5 |
| pg-single | `n0` | r03_revision_check | 39k | 0.13 | 0.36 | 37 | 590831 | 0 | 2.3 |
| pg-single | `n0` | r04_list_installations | 2.6k | 0.78 | 75 | 79 | 38501 | 0 | 1.0 |
| pg-single | `n0` | r05_search_key | 25k | 0.17 | 0.48 | 51 | 368947 | 0 | 1.9 |
| pg-single | `n1` | r01_effective_config | 20k | 0.16 | 0.47 | 47 | 304729 | 0 | 2.7 |
| pg-single | `n1` | r02_read_key | 23k | 0.15 | 0.41 | 41 | 350084 | 0 | 0.4 |
| pg-single | `n1` | r03_revision_check | 42k | 0.12 | 0.55 | 37 | 626709 | 0 | 16.5 |
| pg-single | `n1` | r04_list_installations | 1.9k | 1.01 | 72 | 80 | 29697 | 0 | 25.1 |
| pg-single | `n1` | r05_search_key | 26k | 0.16 | 0.53 | 49 | 382245 | 0 | 0.6 |
| pg-single | `n3` | r01_effective_config | 20k | 0.16 | 0.45 | 47 | 292476 | 0 | 13.2 |
| pg-single | `n3` | r02_read_key | 24k | 0.15 | 0.40 | 41 | 353664 | 0 | 2.5 |
| pg-single | `n3` | r03_revision_check | 38k | 0.14 | 0.38 | 36 | 571559 | 0 | 3.8 |
| pg-single | `n3` | r04_list_installations | 14k | 0.22 | 0.76 | 62 | 214755 | 0 | 4.0 |
| pg-single | `n3` | r05_search_key | 24k | 0.18 | 0.59 | 51 | 347859 | 0 | 12.2 |
| pg-single | `n4` | r01_effective_config | 20k | 0.16 | 0.44 | 47 | 315520 | 0 | 12.2 |
| pg-single | `n4` | r02_read_key | 24k | 0.14 | 0.40 | 40 | 357924 | 0 | 2.2 |
| pg-single | `n4` | r03_revision_check | 38k | 0.13 | 0.38 | 37 | 576430 | 0 | 5.3 |
| pg-single | `n4` | r04_list_installations | 14k | 0.22 | 0.68 | 62 | 217298 | 0 | 2.0 |
| pg-single | `n4` | r05_search_key | 24k | 0.17 | 0.49 | 50 | 365006 | 0 | 3.4 |
