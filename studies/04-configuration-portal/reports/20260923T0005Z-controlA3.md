# Study 04 — configuration portal — run `20260923T0005Z-controlA3`

Generated 2026-09-22T23:54:13Z from 1 result file(s). This report contains measurements only.

| Field | Value |
|---|---|
| Study | 04-configuration-portal |
| Run id | `20260923T0005Z-controlA3` |
...
| **Inputs digest** | `0ae57aca9b145cbe` |
| Cells | 1 |
...
- Highest and lowest valid read result, across all cells and reads: 44032.8 ops/s (`pg-single/n1/r03_revision_check`) and 1384.0 ops/s (`pg-single/n1/r04_list_installations`).

This list ranks by number only. Which design is *better* is not a measurement and is not stated here.

## Analyses of this data

No signed analysis exists yet for inputs digest `0ae57aca9b145cbe`.
...
|---|---|---|---|---|---|---|---|---|---|
| pg-single | `n1` | r01_effective_config | 16k | 0.17 | 0.53 | 56 | 237457 | 0 | 2.4 |
| pg-single | `n1` | r02_read_key | 29k | 0.12 | 0.33 | 39 | 432882 | 0 | 0.6 |
| pg-single | `n1` | r03_revision_check | 44k | 0.12 | 0.32 | 38 | 667761 | 0 | 3.4 |
| pg-single | `n1` | r04_list_installations | 1.4k | 1.36 | 78 | 83 | 20731 | 0 | 0.5 |
| pg-single | `n1` | r05_search_key | 28k | 0.15 | 0.46 | 49 | 410104 | 0 | 3.4 |
