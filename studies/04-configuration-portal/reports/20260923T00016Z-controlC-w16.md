# Study 04 — configuration portal — run `20260923T00016Z-controlC-w16`

Generated 2026-09-22T23:48:10Z from 2 result file(s). This report contains measurements only.

| Field | Value |
|---|---|
| Study | 04-configuration-portal |
| Run id | `20260923T00016Z-controlC-w16` |
...
| **Inputs digest** | `b7be7bc618f32a26` |
| Cells | 2 |

## TL;DR — measured facts, selected by fixed rules

- Cells reported: 2; cells that failed: 2.
  - failed: `pg-single/c1_optimistic_version` (phase contention: audit after contention failed: INV-3/INV-10: installation 1 is missing key "auth.timeout_056")
...
- Invariant violations recorded: 2.
  - `pg-single/c1_optimistic_version`: INV-3/INV-10: installation 1 is missing key "auth.timeout_056"
...
No signed analysis exists yet for inputs digest `b7be7bc618f32a26`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `c1` | optimistic | 16 | 10950 | 3034 | 57069 | 613 | 47 | 10950 | 10950 | 0 |  |
| pg-single | `c2` | pessimistic | 16 | 18068 | 0 | 0 | 1.1k | 60 | 18068 | 18068 | 0 |  |
...
|---|---|---|---|---|---|---|---|---|
| pg-single | `c1` | 1 | false | 24 | 1 | 0 |  | INV-3/INV-10: installation 1 is missing key "auth.timeout_056" |
