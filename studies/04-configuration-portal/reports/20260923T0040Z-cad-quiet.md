# Study 04 — configuration portal — run `20260923T0040Z-cad-quiet`

Generated 2026-09-23T01:07:09Z from 2 result file(s). This report contains measurements only.

| Field | Value |
|---|---|
| Study | 04-configuration-portal |
| Run id | `20260923T0040Z-cad-quiet` |
| Environment | `host-zenbook-ux5406sa` |
| Repository commit | `5f2f36fe24fcf898d27e8285451a7d872186a11b` |
| `git describe` | `run/04-configuration-portal/20260923T0030Z-card-t500` |
| Working tree dirty at start | false |
| Run tag | `run/04-configuration-portal/20260923T0040Z-cad-quiet` |
| **Inputs digest** | `89d43e0f746560e8` |
| Cells | 2 |
...
No signed analysis exists yet for inputs digest `89d43e0f746560e8`.

## Cells

| Topology | Design | Family | Kind | Gate | Load s | Entries | Serialized B |
|---|---|---|---|---|---|---|---|
| pg-single | `n3_rollup_trigger` | rollup | rows | pass | 0.07 | 7200 | 798.3 KiB |
...
|---|---|---|---|---|---|---|---|---|
| pg-single | `n3` | w01_modify_key | 1.2k | 0.84 | 1.27 | 17524 | 0 | 3.4 |
| pg-single | `n3` | w02_add_key | 1.1k | 0.89 | 1.36 | 16426 | 0 | 8.4 |
| pg-single | `n3` | w03_delete_key | 492 | 1.98 | 2.75 | 7404 | 0 | 1.7 |
| pg-single | `n3` | w04_publish_batch | 286 | 2.97 | 12 | 4255 | 0 | 21.1 |
| pg-single | `n3` | w05_replace_all | 10.0 | 29 | 292 | 178 | 0 | 145.7 |
| pg-single | `n3` | w06_update_metadata | 1.7k | 0.58 | 0.96 | 25111 | 0 | 3.3 |
| pg-single | `n4` | w01_modify_key | 1.1k | 0.85 | 1.43 | 16964 | 0 | 0.8 |
| pg-single | `n4` | w02_add_key | 1.0k | 0.94 | 1.48 | 15506 | 0 | 6.2 |
| pg-single | `n4` | w03_delete_key | 512 | 1.92 | 2.89 | 7595 | 0 | 7.1 |
| pg-single | `n4` | w04_publish_batch | 690 | 1.42 | 2.12 | 10323 | 0 | 19.0 |
| pg-single | `n4` | w05_replace_all | 413 | 2.32 | 3.51 | 6173 | 0 | 4.4 |
| pg-single | `n4` | w06_update_metadata | 1.7k | 0.59 | 0.95 | 24782 | 0 | 0.2 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `n3` | minutely | 60 | 1.0000 | 5 | 5 | 5 | 0 | 0 | false | 0.31 | false |
| pg-single | `n4` | minutely | 60 | 1.0000 | 5 | 5 | 5 | 0 | 0 | false | 0.95 | false |
