# Study 04 — configuration portal — run `20260923T0001Z-controlB-r1`

Generated 2026-09-22T23:45:16Z from 1 result file(s). This report contains measurements only.

| Field | Value |
|---|---|
| Study | 04-configuration-portal |
| Run id | `20260923T0001Z-controlB-r1` |
...
| **Inputs digest** | `6a21a6cc19560902` |
| Cells | 1 |

## TL;DR — measured facts, selected by fixed rules

- Cells reported: 1; cells that failed: 1.
...
- Invariant violations recorded: 1.
...
No signed analysis exists yet for inputs digest `6a21a6cc19560902`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `c1` | optimistic | 16 | 11572 | 27786 | 60253 | 721 | 12 | 11572 | 11572 | 0 |  |
