# Study 04 — configuration portal — run `20260923T0001Z-controlC-w1`

Generated 2026-09-22T23:46:15Z from 2 result file(s). This report contains measurements only.

| Field | Value |
|---|---|
| Study | 04-configuration-portal |
| Run id | `20260923T0001Z-controlC-w1` |
...
| **Inputs digest** | `16146150ddce0d9f` |
| Cells | 2 |

## TL;DR — measured facts, selected by fixed rules

- Cells reported: 2; cells that failed: 2.
  - failed: `pg-single/c1_optimistic_version` (phase contention: audit after contention failed: INV-3/INV-10: installation 1 is missing key "db.retry_limit_012")
  - failed: `pg-single/c2_pessimistic_lock` (phase contention: audit after contention failed: INV-3/INV-10: installation 1 is missing key "auth.pool_size_038")
- Negative controls that fired: 0. Controls that did NOT fire: 0.
- Invariant violations recorded: 2.
  - `pg-single/c1_optimistic_version`: INV-3/INV-10: installation 1 is missing key "db.retry_limit_012"
  - `pg-single/c2_pessimistic_lock`: INV-3/INV-10: installation 1 is missing key "auth.pool_size_038"

This list ranks by number only. Which design is *better* is not a measurement and is not stated here.

## Analyses of this data

No signed analysis exists yet for inputs digest `16146150ddce0d9f`.

## Cells

| Topology | Design | Family | Kind | Gate | Load s | Entries | Serialized B |
|---|---|---|---|---|---|---|---|
| pg-single | `c1_optimistic_version` | concurrency | rows | aborted | 0.05 | 3600 | 399.8 KiB |
| pg-single | `c2_pessimistic_lock` | concurrency | rows | aborted | 0.06 | 3600 | 399.8 KiB |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| pg-single | `c1` | optimistic | 1 | 21160 | 0 | 0 | 1.2k | 1.41 | 21160 | 21160 | 0 |  |
| pg-single | `c2` | pessimistic | 1 | 20156 | 0 | 0 | 1.2k | 1.43 | 20156 | 20156 | 0 |  |
...
|---|---|---|---|---|---|---|---|---|
| pg-single | `c1` | 1 | false | 24 | 1 | 0 |  | INV-3/INV-10: installation 1 is missing key "db.retry_limit_012" |
| pg-single | `c2` | 1 | false | 24 | 1 | 0 |  | INV-3/INV-10: installation 1 is missing key "auth.pool_size_038" |
