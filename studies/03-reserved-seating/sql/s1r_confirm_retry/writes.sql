-- S1r — confirm-retry: every statement the hold, checkout, sweeper, refund
...
--   w_insert_tickets
--   S1r: if w_confirm_seats matched fewer seats than the hold, the harness rolls
--   back and runs this whole transaction once more, at once. The second answer
--   stands (ER-01, HANDOFF AM-01.3).
--
