-- E1 — sweeper-expiry: the read catalogue.
--
-- Names and result shapes are identical in every design; verification compares
-- them with Go-computed truth. Expiry is NOT judged at read time: status is
-- trusted, so a hold shows as held until the sweeper releases it.
