...
|---|---|---:|---:|---:|---:|---|
| D9 hybrid | 4:4 | 3.0k | **100%** | 988 | 1.21 | yes |
| D9 hybrid | 2:6 | 1.4k | **48%** | 2.0k | 1.00 | **NO — 3 rows wrong** |
| D9 hybrid | 4:4 | 2.7k | **89%** | 924 | 2.36 | **NO — 2 rows wrong** |
| D9 hybrid | 2:6 | 1.2k | **39%** | 1.7k | 0.87 | **NO — 4 rows wrong** |
| D10 hybrid/locked | 4:4 | 2.8k | **100%** | 878 | 1.91 | yes |
| D10 hybrid/locked | 2:6 | 1.4k | **52%** | 1.9k | 0.89 | yes |
| D10 hybrid/locked | 4:4 | 2.6k | **95%** | 921 | 1.42 | yes |
| D10 hybrid/locked | 2:6 | 1.3k | **49%** | 1.8k | 0.90 | yes |
...
|---|---:|---:|
| Information of the last donation (one charity) | 38% | 47% | 
| Who donates the most | 37% | 51% | 
| First and last donation of a person | 38% | 49% | 
| Total donated (global) | 37% | 51% | 
| Total donated (one charity) | 39% | 52% | 
| A person's 20 most recent donations | 39% | 48% | 
| Donation by id (point lookup) | 39% | 48% | 
| How many donations a person made | 39% | 48% | 
| Charity activity feed (last 50, with names) | 39% | 49% | 
...
| Run id | `20260913-cache-fix` |
| Result files | 2 |
| **Inputs digest** | `b2f4534962a39346` |
...
|---|---|---|---|---|---|
| [claude-opus-5](analyses/20260912-study01--claude-opus-5--2026-09-12.md) | ai | 2026-09-12 | `b2f4534962a39346` ✅ | current | Store totals on the parent only for aggregate questions and only when writes spread across many parents; use indexes for everything else; embedding donations in the donor row never came out ahead on reads. |
| [gpt-6](analyses/20260912-study01--gpt-6--2026-09-12.md) | ai | 2026-09-12 | `b2f4534962a39346` ✅ | current | Use ordinary indexes for donor reads, copy the charity key when it enables selective charity indexes, and store totals only when their read benefit justifies contention and maintenance. |
...
`b2f4534962a39346`, read it first. Add a new analysis to **disagree, extend, or bring a
