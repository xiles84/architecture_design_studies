...
| | |
|---|---|
| Run id | `20260913-portal-unbounded` |
...
|---|---|---:|---:|---:|---:|---|
| D3 flat+FK | 8:0 | 29k | baseline | — | 0.64 | — |
| D3 flat+FK | 6:2 | 18k | **63%** | 726 | 0.79 | — |
| D6 embedded | 8:0 | 23k | baseline | — | 0.84 | — |
| D6 embedded | 6:2 | 14k | **62%** | 517 | 1.09 | — |
| D9 hybrid | 8:0 | 24k | baseline | — | 0.74 | — |
| D9 hybrid | 6:2 | 15k | **64%** | 642 | 0.89 | yes |
...
|---|---:|---:|---:|
| First and last donation of a person | 64% | 63% | 64% | 
| A person's 20 most recent donations | 63% | 61% | 64% | 
| How many donations a person made | 63% | 62% | 65% | 
...
| Run id | `20260913-portal-unbounded` |
| Result files | 3 |
| **Inputs digest** | `9422b562aa5cd81e` |
...
|---|---|---|---|---|---|
| [claude-opus-5](analyses/20260912-study01--claude-opus-5--2026-09-12.md) | ai | 2026-09-12 | `9422b562aa5cd81e` ✅ | current | Store totals on the parent only for aggregate questions and only when writes spread across many parents; use indexes for everything else; embedding donations in the donor row never came out ahead on reads. |
| [gpt-6](analyses/20260912-study01--gpt-6--2026-09-12.md) | ai | 2026-09-12 | `9422b562aa5cd81e` ✅ | current | Use ordinary indexes for donor reads, copy the charity key when it enables selective charity indexes, and store totals only when their read benefit justifies contention and maintenance. |
...
`9422b562aa5cd81e`, read it first. Add a new analysis to **disagree, extend, or bring a
