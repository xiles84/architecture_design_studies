-- Write statements for D3/D4/D7. The denormalised charity_id must be supplied
-- by the writer, which is the maintenance burden the design trades for its
-- faster charity-scoped reads. For D4 the INSERT below also fires the rollup
-- trigger; the statement text is identical, which is the point of comparing them.
