# Execution brief — Fix figure numbering, SVG text stretching and marker tracking
...
Fix figure numbering, SVG text stretching and marker tracking. Read `task.json` for the acceptance criteria; they are the contract.
