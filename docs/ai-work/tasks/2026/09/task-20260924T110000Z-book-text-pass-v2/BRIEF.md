# Execution brief — Text and terminology pass over the book prose
...
Text and terminology pass over the book prose. Read `task.json` for the acceptance criteria; they are the contract.
