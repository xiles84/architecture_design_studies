# Execution brief — Correct the cache mechanism cards and the relaxed-freshness taxonomy
...
Correct the cache mechanism cards and the relaxed-freshness taxonomy. `task.json` holds the acceptance criteria, and they are the contract.
