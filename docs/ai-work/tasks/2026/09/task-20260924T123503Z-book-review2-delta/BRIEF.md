# Execution brief — Apply the review-3 prose, lifecycle-rendering and visual deltas
...
Apply the review-3 prose, lifecycle-rendering and visual deltas. `task.json` holds the acceptance criteria, and they are the contract.
