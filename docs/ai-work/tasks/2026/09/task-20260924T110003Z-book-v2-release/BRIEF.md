# Execution brief — Release Edition 2: rebuild the tracked PDF and tag the edition
...
Release Edition 2: rebuild the tracked PDF and tag the edition. Read `task.json` for the acceptance criteria; they are the contract.
