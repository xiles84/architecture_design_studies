# Execution brief — Audit every claim against its own limits and publish the v5 registry
...
Audit every claim against its own limits and publish the v5 registry. `task.json` holds the acceptance criteria, and they are the contract.
